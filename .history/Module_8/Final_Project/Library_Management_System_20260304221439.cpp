...
int main() {
    ...
    do {
        ...
        // Each case corresponds to a menu option and calls the appropriate function on the Library object.
        ...
        try {
            //SECTION - Switch statement to handle user choices and call corresponding Library functions
            switch (choice) {
