...
// This method displays the book's information, including title, author, genre, and status. If the book is checked out, it also displays the due date and time.
...
//Function to get the current status of the book.
