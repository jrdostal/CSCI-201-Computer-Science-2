...
classDiagram
    class Library {
        ...
        +addBook(Book*)
        +addPatron(Patron)
        +checkoutBook(int, string)
        +returnBook(int, string)
        +displayBooks()
        +displayPatrons()
...
_(Note: As this is a text document, please insert screenshots of the running application in the placeholders below)_
