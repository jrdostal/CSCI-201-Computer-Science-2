...
Book::Book(string t, string a, Genre g, BookType bt, int p) : title(t), author(a), genre(g), type(bt), status(BookStatus::Available), pageCount(p), dueDate(1, 1, 2024), dueTime(12, 0) {};
