//SECTION - Include the SFML graphics library header to use its functionalities for creating a window and drawing shapes. Also include the optional header for handling events in a more modern way.
// Include the SFML graphics library header
