...
int main() {
    ...
    // Position the rectangle at the center of the window
    rectangle1.setPosition({Window_Width / 2.0f - Rectangle_Width / 2.0f, Window_Height / 2.0f - Rectangle_Height / 2.0f});
