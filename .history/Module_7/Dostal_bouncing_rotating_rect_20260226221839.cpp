...
int main() {
    ...
    while (window.isOpen()) {
        ...
        if ((rectangle1.getPosition().x + (rectangle1.getSize().x + 4.0f)) <= 0 || (rectangle1.getPosition().x + rectangle1.getSize().x + 4.0f) >= Window_Width)
        {
            speedX = -speedX;
        }
        ...
        if ((rectangle1.getPosition().y + (rectangle1.getSize().y + 4.0f)) <= 0 || (rectangle1.getPosition().y + rectangle1.getSize().y + 4.0f) >= Window_Height)
        {
            speedY = -speedY;
        }
        ...
        if (boundingBox.position.y <= 0 || (boundingBox.position.y + (boundingBox.size.y + 4.0f)) >= Window_Height)
        {
            speedY = -speedY;
        }
