...
int main() {
    ...
    rectangle1.setPosition({Rectangle_Width + 4.0f, Rectangle_Height + 4.0f});
    ...
    while (window.isOpen()) {
        ...
        if ((rectangle1.getPosition().x - (rectangle1.getSize().x - 3.0f)) <= 0 || (rectangle1.getPosition().x + rectangle1.getSize().x / 3.0f) >= Window_Width)
        {
            speedX = -speedX;
        }
        ...
        if ((rectangle1.getPosition().y - (rectangle1.getSize().y / 3.0f)) <= 0 || (rectangle1.getPosition().y + rectangle1.getSize().y / 3.0f) >= Window_Height)
        {
            speedY = -speedY;
        }
