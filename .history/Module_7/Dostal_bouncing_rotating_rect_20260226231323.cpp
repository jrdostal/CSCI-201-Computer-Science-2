...
int main() {
    ...
    while (window.isOpen()) {
        ...
        if (boundingBox.position.x <= 0 || (boundingBox.size.x + boundingBox.position.x + 4.0f) >= Window_Width)
        ...
        if (boundingBox.position.y <= 0 || (boundingBox.size.y + boundingBox.position.y + 4.0f) >= Window_Height)
