...
int main() {
    ...
    while (window.isOpen()) {
        ...
        if (boundingBox.position.x + 4.0f <= 0 || (boundingBox.size.x + boundingBox.position.x + 4.0f) >= Window_Width)
        {
            speedX = -speedX;
        }
        ...
        if (boundingBox.position.y + 4.0f <= 0 || (boundingBox.size.y + boundingBox.position.y + 4.0f) >= Window_Height)
        {
            speedY = -speedY;
        }
