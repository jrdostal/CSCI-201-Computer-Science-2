...
//SECTION - Define the Server class
...
public:
    ...
    Server(int port);
    // The start method is responsible for setting up the server to listen for incoming connections and handling client requests.
    void start();
