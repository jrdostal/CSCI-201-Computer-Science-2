...
void Pair<TheType>::Output() {
   cout << "First value: " << firstVal << endl;
   cout << "Second value: " << secondVal << endl;
   cout << endl;
}
...
void Pair<TheType>::ShowComparison(Pair<TheType>* otherPair) {
   char comparisonSymbol = CompareWith(otherPair);
   cout << "First pair: " << firstVal << ", " << secondVal << endl;
   cout << "Comparison symbol: " << comparisonSymbol << endl;
   cout << "Second pair: " << otherPair->firstVal << ", " << otherPair->secondVal << endl;
   cout << endl;
   Output();
   otherPair->Output();
}
